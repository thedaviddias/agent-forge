...
- If network approvals / sandbox settings are getting in the way: `references/network-sandbox.md`
...
- **`references/network-sandbox.md`**: environment/sandbox/network-approval troubleshooting (Codex, Cursor, Claude).
