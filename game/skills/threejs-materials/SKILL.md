...
See [references/materials-reference.md](references/materials-reference.md) for environment maps, material cloning and modification, performance tips, and see also.
