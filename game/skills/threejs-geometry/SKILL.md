...
See [references/geometry-reference.md](references/geometry-reference.md) for BufferGeometryUtils, common patterns (center, scale to fit, morph targets), performance tips, and related skills.
